...
setup_page("pages/02_Documentazione.py")
...
2. **Soglia Minima di Rilevanza (Score <= 2.0)**: Qualsiasi analisi che produca un IIPO (Indice di informatività delle pratiche di orientamento) inferiore o uguale a 2.0 viene automaticamente scartata ed eliminata. Un punteggio così basso indica con quasi assoluta certezza che il documento non è un PTOF valido o non contiene alcuna informazione pertinente sull'orientamento, rendendo l'analisi priva di valore.
"""
)
