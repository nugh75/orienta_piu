...
setup_page("pages/18_Amministrazione.py")
...
with st.form("page_settings_form"):
    ...
    default_page = st.selectbox(
        ...
        index=page_options.index(settings.get("default_page", "pages/03_Sintesi.py"))
        if settings.get("default_page", "pages/03_Sintesi.py") in page_options
        else 0,
