...
- **README.md** - Panoramica progetto ([README.md](../../README.md))
- **DASHBOARD_README.md** - Guida completa dashboard
- **TROUBLESHOOTING.md** - Risoluzione problemi ([TROUBLESHOOTING.md](../operations/TROUBLESHOOTING.md))
- **DASHBOARD_STATUS.md** - Questo file (stato sistema)
- **WORKFLOW_README.md** - Workflow analisi PTOF ([WORKFLOW_README.md](../operations/WORKFLOW_README.md))
...
- **Dettagli:** Vedere [DEPRECATION_FIX.md](../maintenance/DEPRECATION_FIX.md)
...
- **Dettagli:** Vedere [FIX_AREA_GEOGRAFICA.md](../maintenance/FIX_AREA_GEOGRAFICA.md)
...
- **Dettagli:** Vedere [FIX_FILTRI_DUPLICATI.md](../maintenance/FIX_FILTRI_DUPLICATI.md)
...
2. **Esegui test sistema:**
   ```bash
   python3 -c "import sys; exec(open('docs/operations/TROUBLESHOOTING.md').read())"
   ```
