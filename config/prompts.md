...
```json
{
    ...
    "ptof_section2": {
        ...
        "2_2_partnership": {
            "score": [Punteggio 1-7 basato sulla qualità delle partnership],
...
5. Per i campi senza evidenze in questo frammento, usa score: 1 (minimo della scala Likert 1-7). NON usare 0.
...
```json
{
  ...
  "ptof_section2": {
    ...
    "2_3_finalita": {
      ...
      "finalita_transizioni_formative": { "score": 1 },
      "finalita_capacita_orientative_opportunita": { "score": 1 }
    },
    "2_4_obiettivi": {
      "obiettivo_ridurre_abbandono": { "score": 1 },
      "obiettivo_continuita_territorio": { "score": 1 },
      "obiettivo_contrastare_neet": { "score": 1 },
      "obiettivo_lifelong_learning": { "score": 1 }
    },
    "2_5_azioni_sistema": {
      "azione_coordinamento_servizi": { "score": 1 },
      "azione_dialogo_docenti_studenti": { "score": 1 },
      "azione_rapporto_scuola_genitori": { "score": 1 },
      "azione_monitoraggio_azioni": { "score": 1 },
      "azione_sistema_integrato_inclusione_fragilita": { "score": 1 }
    },
    "2_6_didattica_orientativa": {
      "didattica_da_esperienza_studenti": { "score": 1 },
      "didattica_laboratoriale": { "score": 1 },
      "didattica_flessibilita_spazi_tempi": { "score": 1 },
      "didattica_interdisciplinare": { "score": 1 }
    },
    "2_7_opzionali_facoltative": {
      "opzionali_culturali": { "score": 1 },
      "opzionali_laboratoriali_espressive": { "score": 1 },
      "opzionali_ludiche_ricreative": { "score": 1 },
      "opzionali_volontariato": { "score": 1 },
      "opzionali_sportive": { "score": 1 }
    }
  },
  "activities_register": [
    {
      ...
      "descrizione_e_metodologia": "Max 100 chars",
      "target": "..."
    }
  ]
}
