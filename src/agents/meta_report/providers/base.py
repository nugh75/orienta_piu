...
class BaseProvider(ABC):
    ...
    def _get_system_prompt(self, report_type: str, prompt_profile: str) -> str:
        ...
        base = (
            ...
            "REGOLE:\n"
            "- Usa prosa narrativa fluida, ma USA elenchi puntati se richiesto per liste di attività.\n"
        ...
        specifics = {
            "school": (
                "Genera un REPORT ANALITICO DETTAGLIATO sulle attività di orientamento della scuola.\n"
                "Usa TUTTE le informazioni disponibili nel JSON (metadata, qualitative_details, practices, narrative).\n\n"
                "STRUTTURA OBBLIGATORIA (Usa titoli Markdown ##):\n\n"
                "## 1. Visione e Contesto\n"
                "Analizza l'identità della scuola e la sua mission orientativa. Cita esplicitamente le finalità (es: sviluppo autonomia, contrasto dispersione) "
                "usando le citazioni presenti in 'qualitative_details'.\n\n"
                "## 2. Ecosistema delle Attività (Divisione per Categorie)\n"
                "Per OGNUNA delle seguenti 6 categorie, crea una sezione dedicata. Se ci sono attività, ELENCALE TUTTE (non fare sintesi, voglio l'elenco completo).\n\n"
                "### 2.1 PCTO e Transizione Scuola-Lavoro\n"
                "Elenca tutti i progetti di PCTO, stage e tirocini. Per ogni progetto indica: Titolo, Target, Ore/Durata.\n\n"
                "### 2.2 Orientamento in Ingresso e Uscita\n"
                "Elenca le attività di continuità (verso le medie) e di orientamento universitario/ITS. Menziona open days, incontri, e mentoring.\n\n"
                "### 2.3 Potenziamento Competenze\n"
                "Elenca progetti per competenze linguistiche, STEM, digitali o trasversali (es: corsi extra, certificazioni).\n\n"
                "### 2.4 Inclusione e Supporto\n"
                "Elenca attività per BES, DSA, Stranieri o contrasto alla dispersione (es: sportelli, laboratori L2).\n\n"
                "### 2.5 Laboratori e Didattica Innovativa\n"
                "Elenca iniziative legate a nuovi ambienti di apprendimento o metodologie didattiche specifiche.\n\n"
                "### 2.6 Altre Iniziative\n"
                "Tutto ciò che non rientra sopra (es: uscite didattiche, progetti civici, ambiente).\n\n"
                "## 3. Analisi Qualitativa\n"
                "Dopo l'elenco, fornisci una breve analisi sui punti di forza trasversali (innovazione, rete territoriale).\n\n"
                "## 4. Dati di Sintesi\n"
                "- Numero totale attività analizzate\n"
                "- Totale fondi citati\n"
                "- Totale partner citati\n\n"
                "REGOLE:\n"
                "- NON riassumere le attività. Se ce ne sono 10 in una categoria, elencale tutte e 10.\n"
                "- Usa un bullet point per ogni attività: '* **Titolo**: Descrizione sintetica (Target, Date, Fondi)'\n"
                "- Se una categoria è vuota, scrivi 'Nessuna attività registrata in questa categoria.'."
            ),
            "regional": (
