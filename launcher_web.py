...
def run_command():
    ...
    commands = {
        ...
        "btn_review_gemini": ["make", "review-gemini", f"MODEL={params.get('model', 'gemini-3-flash-preview')}"],
        "btn_review_scores_gemini": ["make", "review-scores-gemini", f"MODEL={params.get('model', 'gemini-3-flash-preview')}"],
