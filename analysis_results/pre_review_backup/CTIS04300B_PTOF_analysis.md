...
Gli obiettivi del PTOF sono orientati alla riduzione dell'**abbandono scolastico** (punteggio 5), alla continuità territoriale (punteggio 5), al contrasto al fenomeno **NEET** (punteggio 4) e alla promozione del **lifelong learning** (punteggio 5).

**2.5 Azioni di Sistema:**

Le azioni di sistema implementate comprendono il coordinamento dei servizi (punteggio 5), il dialogo tra docenti e studenti (punteggio 4), il rapporto scuola-genitori (punteggio 5), il monitoraggio delle azioni (punteggio 4) e la creazione di un sistema integrato di inclusione e fragilità (punteggio 5).

**2.6 Didattica Orientativa:**

La didattica orientativa si basa sull'apprendimento dall'esperienza degli studenti (punteggio 5), sull'utilizzo di laboratori (punteggio 4), sulla flessibilità degli spazi e dei tempi (punteggio 3) e sull'approccio interdisciplinare (punteggio 5).

**2.7 Offerta di Attività Opzionali:**

L'offerta di attività opzionali include opzioni culturali (punteggio 4), laboratoriali ed espressive (punteggio 5), ludiche e ricreative (punteggio 3), di volontariato (punteggio 4) e sportive (punteggio 5).
...
Il divario principale risiede nella necessità di implementare un sistema di monitoraggio e valutazione più rigoroso per misurare l'impatto delle attività di orientamento. È inoltre necessario definire in modo più preciso le modalità di integrazione delle azioni di inclusione, garantendo un supporto personalizzato agli studenti con bisogni speciali.
